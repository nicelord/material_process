...
public class MailNotif {
    ...
    public void emailKonfirmasiPenerimaan(Manifest m) {
        ...
        String msg = "<html>"
                ...
                + "Keterangan       : " + m.getPenerimaan().getKetRevisi() + " <br/>"
                + "</pre>"
                + "<br/>"
                + "Jika terdapat perbedaan jumlah item pada manifest, silahkan konfirmasi ke bagian penerimaan dan lakukan update data manifest."
                + "<p></p>"
                + "<br/>"
                + "<br/>"
                + "<p><i>Note : "
